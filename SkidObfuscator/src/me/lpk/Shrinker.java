...
public class Shrinker {
	...
	private void shrink(File jar) {
		...
		if (!chkMaxs.isSelected()) {
			try {
				...
				JOptionPane.showMessageDialog(null, "Failed adding input to classpath. Enable 'Use Maxs' to force shrinking.",
						"Error: " + e1.getClass().getSimpleName(), JOptionPane.ERROR_MESSAGE);
				return;
			}
		}
	...
	private void initialize() {
		...
		JLabel lbloptimizedJarsWill = new JLabel("*Optimized jars will be placed ajacent to this program. Optimization only affects file size, not performance. Read tooltips for information (hover over checks).");
	...
	class MyClassOptimizer extends ClassOptimizer {
	    ...
	    public void visitSource(final String source, final String debug) {
	        // remove debug info
			if (!chkSource.isSelected() && cv != null) { cv.visitSource(source, debug); }
	    }

	    @Override
	    public void visitOuterClass(final String owner, final String name, final String desc) {
	        // remove debug info
	    	 if (!chkInnerOuter.isSelected() && cv != null) { cv.visitOuterClass(owner, name, desc); }
	    }

	    @Override
	    public void visitInnerClass(final String name, final String outerName, final String innerName, final int access) {
	        // remove debug info
	    	if (!chkInnerOuter.isSelected() && cv != null) {  cv.visitInnerClass(name, outerName, innerName, access); }
	    }
	    @Override
	    public AnnotationVisitor visitAnnotation(final String desc,  final boolean visible) {
	        // remove annotations
	    	if (!chkClassAnnotations.isSelected() && cv != null) {  return cv.visitAnnotation(desc, visible); }
	         return null;
	    }
	    ...
	    public AnnotationVisitor visitTypeAnnotation(int typeRef,  TypePath typePath, String desc, boolean visible) {
	        // remove annotations
	    	if (!chkClassAnnotations.isSelected() && cv != null) {  return cv.visitTypeAnnotation(typeRef, typePath, desc, visible);  }
	        return null;
	    }
	    ...
	    public void visitAttribute(final Attribute attr) {
	    	...
	    	if (!chkClassAttribs.isSelected() &&  cv != null) {  cv.visitAttribute(attr); }
	    }
	...
	class MyMethodOptimizer extends MethodOptimizer {
	    ...
	    public void visitParameter(String name, int access) {
	    	...
	    	if (!chkParameter.isSelected() && mv != null) { mv.visitParameter(name, access);}
	    }

	    @Override
	    public AnnotationVisitor visitAnnotationDefault() {
	        // remove annotations
	    	if (!chkMethodsAnnotations.isSelected() && mv != null) { mv.visitAnnotationDefault(); }
	        return null;
	    }
	    ...
	    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
	        // remove annotations
	    	if (!chkMethodsAnnotations.isSelected() && mv != null) { mv.visitAnnotation(desc, visible); }
	        return null;
	    }

	    @Override
	    public AnnotationVisitor visitTypeAnnotation(int typeRef,  TypePath typePath, String desc, boolean visible) {
	    	if (!chkMethodsAnnotations.isSelected() && mv != null) { mv.visitTypeAnnotation(typeRef, typePath, desc, visible); }
	        return null;
	    }
	    ...
	    public AnnotationVisitor visitParameterAnnotation(final int parameter, final String desc, final boolean visible) {
	        // remove annotations
	    	if (!chkMethodsAnnotations.isSelected() && mv != null) { mv.visitParameterAnnotation(parameter, desc, visible); }
	        return null;
	    }
	    ...
	    public void visitLocalVariable(final String name, final String desc, final String signature, final Label start, final Label end, final int index) {
	        // remove debug info
	    	if (!chkLocals.isSelected() && mv != null) { mv.visitLocalVariable(name, desc, signature, start, end, index); }
	    }

	    @Override
	    public void visitLineNumber(final int line, final Label start) {
	        // remove debug info
	    	if (!chkLines.isSelected() && mv != null) { mv.visitLineNumber(line, start);}
	    }

	    @Override
	    public void visitFrame(int type, int nLocal, Object[] local, int nStack,  Object[] stack) {
	        // remove frame info
	    	if (!chkFrames.isSelected() && mv != null) { mv.visitFrame(type, nLocal, local, nStack, stack); }
	    }

	    @Override
	    public void visitAttribute(Attribute attr) {
	        // remove non standard attributes
	    	if (!chkMethodAttribs.isSelected() && mv != null) { mv.visitAttribute(attr); }
	    }

		@Override
		public void visitLdcInsn(Object cst) {
			// Cancelling what MethodOptimizer does
			if (mv != null) { mv.visitLdcInsn(remapper.mapValue(cst)); }
		}

		@Override
		public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
			// Cancelling what MethodOptimizer does
			if (mv != null) { mv.visitMethodInsn(opcode, remapper.mapType(owner), remapper.mapMethodName(owner, name, desc), remapper.mapMethodDesc(desc), itf); }
		}
	}
}
